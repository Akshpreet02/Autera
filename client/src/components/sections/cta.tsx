      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-medium text-white sm:text-4xl max-w-3xl mx-auto leading-tight">
            ...
            <span className="block text-gray-400 mt-2">Get started with AI automation today.</span>
          </h2>
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="#services">
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto px-8 py-3 border border-gray-400 text-base font-normal rounded-md text-gray-300 hover:bg-gray-800 hover:text-gray-100 transition-colors duration-200"
              >
                Learn More
              </Button>
            </a>
